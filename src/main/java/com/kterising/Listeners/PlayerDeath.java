...
public class PlayerDeath implements Listener {
    ...
    public void Death(PlayerDeathEvent event) {
        ...
        String title = ChatColor.translateAlternateColorCodes('&', MessagesConfig.get().getString("title.player-died.title"));
        String subtitle = ChatColor.translateAlternateColorCodes('&', MessagesConfig.get().getString("title.player-died.sub"));
